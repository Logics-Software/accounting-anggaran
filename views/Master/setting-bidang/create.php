            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <h4 class="mb-0">Tambah Data Setting Bidang</h4>
                    </div>
                </div>
                <form method="POST" action="/setting-bidang/create">
                <div class="card-body">
                        <div class="row">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const form = document.querySelector('form[action="/setting-bidang/create"]');
    ...
    if (typeof initFormSubmitHandler === 'function') {
        initFormSubmitHandler('form[action="/setting-bidang/create"]', {
