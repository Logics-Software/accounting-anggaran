        ...
        <div class="col-12">
            <nav aria-label="breadcrumb" data-breadcrumb-parent="/setting-bagian">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit Bagian/Fakultas</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <h4 class="mb-0">Edit Data Bagian/Fakultas</h4>
                    </div>
                </div>

                <form method="POST" action="/setting-bagian/edit/<?= $item['id'] ?>">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <label for="namabagian" class="form-label">Nama Bagian/Fakultas <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="namabagian" name="namabagian" value="<?= htmlspecialchars($item['namabagian'] ?? '') ?>" required placeholder="Masukkan nama bagian">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <div class="form-check form-switch">
                                    ...
                                    <label class="form-label ms-1 mb-0 mt-1" for="pengelola_akun">
                                    Pengelola Akun
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="jabatan_pimpinan" name="jabatan_pimpinan" value="<?= htmlspecialchars($item['jabatan_pimpinan'] ?? '') ?>" placeholder="Contoh: Kepala Bagian">
                            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const form = document.querySelector('form[action*="/setting-bagian/edit/"]');
    ...
    if (typeof initFormSubmitHandler === 'function') {
        initFormSubmitHandler('form[action*="/setting-bagian/edit/"]', {
