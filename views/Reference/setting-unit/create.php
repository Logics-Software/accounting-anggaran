        ...
        <div class="col-12">
            <nav aria-label="breadcrumb" data-breadcrumb-parent="/setting-unit">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Tambah Unit/Prodi</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <h4 class="mb-0">Tambah Data Unit/Prodi</h4>
                    </div>
                </div>
                <form method="POST" action="/setting-unit/create">
                <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <label for="namaunit" class="form-label">Nama Unit/Prodi <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="namaunit" name="namaunit" required placeholder="Masukkan nama unit">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="id_bagian" name="id_bagian">
                                    ...
                                    <option value="<?= $bagian['id'] ?>"><?= htmlspecialchars($bagian['namabagian'] ?? '') ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="jabatan_pimpinan" name="jabatan_pimpinan" placeholder="Contoh: Kepala Unit">
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    if (typeof initFormSubmitHandler === 'function') {
        initFormSubmitHandler('form[action="/setting-unit/create"]', {
