								...
								<tr class="<?= !$message['is_read'] ? 'table-warning' : '' ?>">
										...
										<div class="d-flex align-items-center">
											...
											<?php if (!empty($message['sender_picture'])): ?>
												<img src="<?= BASE_URL . $config['upload_url'] . htmlspecialchars($message['sender_picture']) ?>" 
														...
														class="rounded-circle me-2 avatar-xs"
														onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
											<?php else: ?>
												<div class="bg-primary text-white rounded-circle d-flex align-items-center justify-content-center me-2 avatar-xs">
													<?= $avatarInitial ?>
												</div>
											<?php endif; ?>
											<div>
									...
									<td>
										<div class="d-flex gap-1">
											...
											<a href="/messages/delete/<?= $message['id'] ?>?from=inbox" class="btn btn-danger btn-sm" 
